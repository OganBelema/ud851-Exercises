...
public class MainActivity extends AppCompatActivity {
    ...
    private final static ArrayList<String> mLifecycleCallbacks = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay
        for (int i = mLifecycleCallbacks.size() - 1; i > -1; i-- ){
            mLifecycleDisplay.append(mLifecycleCallbacks.get(i) + "\n");
        }

        //  (5) Clear mLifecycleCallbacks after iterating through it
