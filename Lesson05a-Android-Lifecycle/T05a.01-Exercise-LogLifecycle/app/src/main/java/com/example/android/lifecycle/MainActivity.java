...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  (1) Use logAndAppend within onCreate
        logAndAppend(ON_CREATE);
    }

    //  (2) Override onStart, call super.onStart, and call logAndAppend with ON_START
    ...
    //  (3) Override onResume, call super.onResume, and call logAndAppend with ON_RESUME
    ...
    //  (4) Override onPause, call super.onPause, and call logAndAppend with ON_PAUSE
    ...
    //  (5) Override onStop, call super.onStop, and call logAndAppend with ON_STOP
    ...
    //  (6) Override onRestart, call super.onRestart, and call logAndAppend with ON_RESTART
    ...
    //  (7) Override onDestroy, call super.onDestroy, and call logAndAppend with ON_DESTROY
