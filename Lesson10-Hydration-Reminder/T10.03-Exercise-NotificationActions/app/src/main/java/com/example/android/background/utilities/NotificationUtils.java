...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 2345;
    private static final int ACTION_INCREMENT_PENDING_INTENT_ID = 3009;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        return new NotificationCompat.Action(R.drawable.ic_cancel_black_24px, "No, thanks",
                pendingIntent);
    }
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,
                ACTION_INCREMENT_PENDING_INTENT_ID,
                intent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        return new NotificationCompat.Action(R.drawable.ic_cancel_black_24px, "I did it!",
                pendingIntent);
    }
