...
public class NotificationUtils {
    ...
    private static final int MAIN_ACTIVITY_PENDING_INTENT_ID = 120;

    private static final int WATER_REMINDER_NOTIFICATION_ID = 2309;

    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "water_reminder_channel";
    ...
    // https://developer.android.com/training/notify-user/build-notification.html
        ...
        //  (10) In the remindUserBecauseCharging method use NotificationCompat.Builder to create a notification
        // that:
        ...
        //  (11) If the build version is greater than or equal to JELLY_BEAN and less than OREO,
