...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_JSON_KEY = "search_json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            if (savedInstanceState.containsKey(QUERY_URL_KEY) &&
                    savedInstanceState.containsKey(SEARCH_JSON_KEY)){
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_JSON_KEY, mSearchResultsTextView.getText().toString());
    }
